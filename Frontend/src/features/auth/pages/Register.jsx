...
import { FiUser, FiMail, FiLock, FiEye, FiEyeOff, FiZap, FiAlertCircle } from 'react-icons/fi'
  ...
  return (
    <main className="auth-page">
      ...
      >
        ...
        <p className="auth-card__subtitle">Start landing interviews with AI on your side.</p>
